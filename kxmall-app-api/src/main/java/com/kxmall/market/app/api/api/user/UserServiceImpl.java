...
import com.kxmall.market.core.notify.SmsbaoSMSClient;
import com.kxmall.market.core.util.GeneratorUtil;
import com.kxmall.market.core.util.SHAUtil;
import com.kxmall.market.core.util.WxUtil;
...
//        }
    ...
    public UserDTO phoneLoginOrRegister(String phone, String verifyCode, String ip, String openId, String p) throws ServiceException {
        ...
        UserDO userDO;
        Date now = new Date();
        List<UserDO> UserDOByPhoneList = userMapper.selectList(new EntityWrapper<UserDO>().eq("phone", phone));
        ...
        try {
            ...
            if (org.apache.commons.lang3.StringUtils.isNoneBlank(result) && json.containsKey("phoneNumber")) {
                ...
                if (org.apache.commons.lang3.StringUtils.isNoneBlank(phone)) {
                    UserDO userDO;
                    List<UserDO> userDOS = userMapper.selectList(new EntityWrapper<UserDO>().eq("phone", phone).eq("login_type", loginType));
