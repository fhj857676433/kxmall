...
import com.kxmall.market.admin.api.api.role.RoleServiceImpl;
...
import com.kxmall.market.admin.exception.AdminExceptionDefinition;
import com.kxmall.market.admin.exception.AdminServiceException;
...
public class ApiManager implements InitializingBean, ApplicationContextAware {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        Reflections reflections = new Reflections(new ConfigurationBuilder().forPackages("com.kxmall.market").addScanners(new SubTypesScanner()).addScanners(new FieldAnnotationsScanner()));
...
//                throw new LauncherServiceException(LauncherExceptionDefinition.LAUNCHER_API_REGISTER_FAILED);
        ...
        for (String gpKey : gpKeys) {
            ...
            for (String methodNameKey : methodNameKeys) {
                ...
                if (httpMethod != null) {
                    ...
                    if (retType.startsWith("com.kxmall") || retType.startsWith("java.util.List<com.kxmall")) {
    ...
    private void addChildParameter(List<Map<String,List<ApiDocumentModel.Field>>> pa, Field returnType) {
        ...
        if (retTypeBack.startsWith("com.kxmall")) {
    ...
    private void addChildParameter2(List<Map<String,List<ApiDocumentModel.Parameter>>> pa, Parameter parameter) {
        ...
        if (retTypeBack.startsWith("class com.kxmall")) {
