package com.kxmall.market.plugin.core.manager;

import com.kxmall.market.plugin.core.inter.AbstractPlugin;
...
public class PluginsManager {
    ...
    public void registerPlugin(AbstractPlugin plugin) {
        ...
        for (Class clazz : interfaces) {
            ...
            if (name.startsWith("com.kxmall.market.plugin.core.inter")) {
