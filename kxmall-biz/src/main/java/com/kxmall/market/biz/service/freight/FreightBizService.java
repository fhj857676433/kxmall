...
import com.kxmall.market.data.mapper.FreightTemplateCarriageMapper;
import com.kxmall.market.data.mapper.FreightTemplateMapper;
...
public class FreightBizService {
    ...
    public Integer getFreightMoney(OrderRequestDTO orderRequestDTO) {
        ...
        Integer discount = orderRequestDTO.getCoupon() != null ? orderRequestDTO.getCoupon().getCouponDO().getDiscount() : 0;
