...
import com.kxmall.market.data.dto.freight.ShipTraceItemDTO;
import com.kxmall.market.data.enums.ShipCodeType;
...
public class KdniaoTrackQueryAPI implements ShipTraceQuery {
    ...
    @Value("${com.kxmall.ship.query.kdn.app-key}")
    private String businessID;

    @Value("${com.kxmall.ship.query.kdn.business-id}")
